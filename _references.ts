...
// STATICS
/// <reference path="./src/scripts/states.ts"/>

// APP
/// <reference path="./src/scripts/boligfApp.ts"/>
...
/// <reference path="./src/scripts/components/association/associationMemberService.ts" />
...
/// <reference path="./src/scripts/components/login/loginController.ts" />
